			...
			<div class="col-md-5 offset-md-4">
				<div class="card" style='border: 4px solid #28328c;'>
					<div class="card-body">
						...
						<h4 class="text-center ">PractoClone Registration</h4>

						<form id="regForm" modelAttribute="customer"
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Email</label><input name="email"
									type="email" class="form-control" id="email" pattern="^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$"
									aria-describedby="emailHelp" placeholder="Enter Email" required = "required"> 
								<small id="emailHelp" class="form-text text-muted">We
									will never share your E-mail</small>
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Phone Number</label><input
									name="number" type="text" class="form-control" id="number"
									aria-describedby="emailHelp" placeholder="Phone Number" pattern = "^\d{10}$" required = "required">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Age</label><input name="age"
									type="text" class="form-control" id="age"
									aria-describedby="emailHelp" placeholder="Age" required = "required">
							</div>
